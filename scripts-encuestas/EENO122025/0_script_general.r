...
RUTA_EXPORTACION_TABLA <- "C:\\Users\\vanev\\Documents\\Opol\\Opol Cuarta EEN - DIC25\\DISTRIBUCION_MUESTRA_PONDERADA_FINAL.csv"
...
RUTA_EXPORTACION_PROVINCIA_VOTO <- "C:\\Users\\vanev\\Documents\\Opol\\Opol Cuarta EEN - DIC25\\intencion_voto_provincia_sexo_votos_validos.csv"
...
RUTA_EXPORTACION_PROVINCIA_VOTO <- "C:\\Users\\vanev\\Documents\\Opol\\Opol Cuarta EEN - DIC25\\intencion_voto_diputados_provincia_sexo_votos_validos.csv"
readr::write_csv(resultados_csv_provincia_voto_valido, RUTA_EXPORTACION_PROVINCIA_VOTO)
...
RUTA_EXPORTACION_NACIONAL_VOTO <- "C:\\Users\\vanev\\Documents\\Opol\\Opol Cuarta EEN - DIC25\\intencion_voto_nacional_votos_validos_por_sexo.csv"
...
distribucion_bruta_provincia <- df_analisis_total %>%
    ...
    mutate(
        Etiqueta_Final = round(`% Muestra Bruta`, 1)
    ) %>%
...
distribucion_bruta_provincia <- df_analisis_total %>%
    ...
    mutate(
        Etiqueta_Final = round(`% Muestra`, 1)
    ) %>%
...
cat("\n✅ Todos los objetos de gráficos (grafico_voto_mejorado, grafico_religion, etc.) han sido generados y almacenados en el ambiente de R. Puedes imprimirlos o guardarlos manualmente.\n")
  ...
  CARPETA_EXPORTACION <- "C:/Users/vanev/Documents/Opol/Opol Cuarta EEN - DIC25/Graficos/"
...
# 4. Clasificar y resumir para IMPRESIÓN DE DATOS
  ...
  CARPETA_EXPORTACION <- "C:/Users/vanev/Documents/Opol/Opol Cuarta EEN - DIC25/Graficos/Provincias/"
