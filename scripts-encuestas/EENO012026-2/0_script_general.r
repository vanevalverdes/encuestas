...
RUTA_BASE_DATOS <- "C:\\Users\\vanev\\Documents\\Opol\\Opol VII EEN - ENE26\\survey.csv"
...
# 4. Exportación
RUTA_EXPORTACION_CONSOLIDADA <- "C:\\Users\\vanev\\Documents\\Opol\\Opol VII EEN - ENE26\\CUADRO_CONSOLIDADO_PONDERACION.csv"
...
RUTA_EXPORTACION_TABLA <- "C:\\Users\\vanev\\Documents\\Opol\\Opol VII EEN - ENE26\\DISTRIBUCION_MUESTRA_PONDERADA_FINAL.csv"
...
RUTA_EXPORTACION_PROVINCIA_VOTO <- "C:\\Users\\vanev\\Documents\\Opol\\Opol VII EEN - ENE26\\intencion_voto_provincia_sexo_votos_validos.csv"
...
RUTA_EXPORTACION_PROVINCIA_VOTO <- "C:\\Users\\vanev\\Documents\\Opol\\Opol VII EEN - ENE26\\intencion_voto_diputados_provincia_sexo_votos_validos.csv"
readr::write_csv(resultados_csv_provincia_voto_valido, RUTA_EXPORTACION_PROVINCIA_VOTO)
...
RUTA_EXPORTACION_NACIONAL_VOTO <- "C:\\Users\\vanev\\Documents\\Opol\\Opol VII EEN - ENE26\\intencion_voto_nacional_votos_validos_por_sexo.csv"
...
cat("\n✅ Todos los objetos de gráficos (grafico_voto_mejorado, grafico_religion, etc.) han sido generados y almacenados en el ambiente de R. Puedes imprimirlos o guardarlos manualmente.\n")
  ...
  CARPETA_EXPORTACION <- "C:/Users/vanev/Documents/Opol/Opol VII EEN - ENE26/Graficos/"
...
# 4. Clasificar y resumir para IMPRESIÓN DE DATOS
  ...
  CARPETA_EXPORTACION <- "C:/Users/vanev/Documents/Opol/Opol VII EEN - ENE26/Graficos/Provincias/"
