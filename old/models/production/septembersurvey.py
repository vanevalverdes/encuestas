...
class Septembersurvey(db.Model):
    __tablename__ = 'septembersurvey'
    ...
    createdby = db.relationship('User', backref='created_septembersurveys', foreign_keys=[createdby_id])
    modifiedby = db.relationship('User', backref='modified_septembersurveys', foreign_keys=[modifiedby_id])
